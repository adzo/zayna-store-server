...
public class UpdateCustomerEndpoint : Endpoint<UpdateCustomerRequest, UpdateCustomerResponse>
{
    ...
    public override void Configure()
    {
        ...
        Summary(s =>
        {
            s.Summary = "Updates an existing customer user";
            s.Description = "Updates the details of a customer user account. Only accessible by administrators.";
            s.Response<UpdateCustomerResponse>(StatusCodes.Status200OK, "Customer updated successfully");
